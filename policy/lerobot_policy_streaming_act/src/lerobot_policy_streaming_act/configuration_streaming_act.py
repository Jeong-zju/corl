...
class StreamingACTConfig(PreTrainedConfig):
    ...
    Args:
        ...
        pre_normalized_observation_keys: Observation keys that are already normalized
            upstream and should therefore skip runtime normalization in the processor fast
            path.
