...
DATASET_ROOT="${DATASET_ROOT:-data/zeno-ai/rrt_connect_h_v30}"
DATASET_REPO_ID="${DATASET_REPO_ID:-zeno-ai/rrt_connect_h_v30}"
OUTPUT_ROOT="${OUTPUT_ROOT:-outputs/train/h_shape_streaming_act}"
JOB_NAME="${JOB_NAME:-streaming_act_h_shape}"
WANDB_PROJECT="${WANDB_PROJECT:-lerobot-rrt-streaming-act}"
